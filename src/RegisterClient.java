        ...
        rejestrujButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (username.isEmpty() || password.isEmpty() || money.isEmpty()) {
                    ...
                    return; // Przerwij działanie metody, jeśli pola są puste
                }

                // Sprawdzenie czy wprowadzona wartość w polu moneyReg jest poprawną liczbą większą od 0
                try {
                ...
                // Zapisz informacje o kliencie do pliku
